...
void create() {
    ...
    set_reset_list( ({
	MOB"penguin", MOB"lynx", MOB"arcticbear", MOB"snowfox", MOB"caribou", MOB"moose", MOB"falcon",
	MOB"foxcub", MOB"leopardcub", MOB"mouse", MOB"snowrabbit", MOB"snowleopard",
	MOB"mink", MOB"seal", MOB"sealpup"
      }) );
    set_properties( ([ "artic" : 1,
	"light" : 1,
	"night light" : 0,
      ]) );
