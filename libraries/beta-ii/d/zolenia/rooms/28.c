...
"ladder" : "The ladder is rickety and made of wood.",
]));
set_exits(([ "east" : ROOMS "27.c",
"west" : ROOMS "29.c"]));
}
void reset() {
    ::reset();
