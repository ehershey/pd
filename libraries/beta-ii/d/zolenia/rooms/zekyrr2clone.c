...
set_long("%^BOLD%^%^BLUE%^The Zekyrr torture room is also a classroom, where the Matron Mother teachers the children of Zekyrr the ways of torturing a dragon.  There are weapons and torture tools littering the floor, scattered alongside random dragon appendages.  There is a grate in the corner of the room, with dragon blood dripping down into it, and a path leading back into the main room of the house.");
set_items(([
...
set_exits(([ "northwest" : ROOMS "51clone.c",
