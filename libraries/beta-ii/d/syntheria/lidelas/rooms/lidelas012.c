...
void create()
{
    ::create();
	    ...
	    set_exits(([
			"east"		: ROOMS "lidelas013.c",
			"north"		: ROOMS "lidelas024.c",
			"west"		: ROOMS "lidelas010.c",
        ]));
}
