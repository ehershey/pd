...
void create()
{
    ::create();
	    ...
	    set_exits(([
			"east"		: ROOMS "lidelas001.c",
			"west"		: ROOMS "lidelas030.c",
			"north"     : ROOMS "lidelas029.c",
        ]));
}
