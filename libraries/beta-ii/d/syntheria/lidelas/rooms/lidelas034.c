...
void create()
{
    ::create();
        set_name("side road");
        set_short("Side road");
        set_long("A small path that is now used as a road. It connects two of the large streets in Lidelas, Feng avenue, and Rutyo street. There are a few small houses here, of a very different style than most of the town. The houses look to be just simple wooden constructions, with no carvings or fancy statues. Smoke bellows out of small chimneys on all of the roofs. Candle light can be seen coming from the small windows in each house.");  
        set_properties( ([
        "light"       : 2,
        "night light" : 2,]) );
        set_items(([
        "houses"    :  "Houses built out of wood, nothing very special about them."
            ...
            set_exits(([
                        ...
                        "north"         : ROOMS "lidelas033.c",
                        "south"         : ROOMS "lidelas035.c",
                        "enter"     : ROOMS "lidelasHouse4.c",
        ]));
