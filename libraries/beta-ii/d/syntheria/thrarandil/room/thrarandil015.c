...
void create()
{
    ::create();
        ...
        set_items(([
            ...
            "spot"          :   "A little section of the road that looks like it has been dug up recently, perhaps something is hidden there.",
        ]));
        set_listen("default", "It is rather quiet in this part of town.");
        set_smell("default", "The strong smell of sea salt fills the air.");
        set_exits(([
                        "west"          : ROOMS "thrarandil016.c",
                        "southeast"     : ROOMS "thrarandil014.c",
        ]));
