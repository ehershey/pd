...
void create()
{
    ::create();
        ...
        set_long("Irminric Circle Street encircles the southern half of Thrarandil. The street is made of worn cobblestone, it looks to be very old. A small unnamed road runs off to the east, it looks to be more of a dirt path than an actual road. Some small buildings line the street, they are the homes of the many workers of the city. Each building has a small window looking out into the street. The homes are made of wood and brick, a sharp contrast to the large stone buildings of the inner city.");  
        set_properties( ([ 
        "town"        : 1, 
        "light"       : 2,
        "night light" : -2,        
        ...
        set_exits(([
			"south"		: ROOMS "thrarandil010.c",
			"east"		: ROOMS "thrarandil012.c",
			"west"		: ROOMS "thrarandil020.c",
        ]));
