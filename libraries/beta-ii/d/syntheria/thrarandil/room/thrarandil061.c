...
void create()
{
    ::create();
        ...
        set_long("Irminric Circle Street encircles the southern half of Thrarandil. The street is made of worn cobblestone, it looks to be very old. Some small buildings line the street, they are the homes of the many workers of the city. Each building has a small window looking out into the street. The homes are made of wood and brick, a sharp contrast to the large stone buildings of the inner city. To the west is a large white tower, it doesn't appear to have any markings on it.");  
        set_properties( ([ 
        "town"        : 1, 
        "light"       : 2,
        "night light" : -2,        
        ...
        set_exits(([
			"southwest"	 : ROOMS "thrarandil060.c",
			"north"      : ROOMS "thrarandil062.c",
        ]));
