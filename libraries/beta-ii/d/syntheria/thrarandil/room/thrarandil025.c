...
void create()
{
    ::create();
        ...
        set_exits(([
			"south"		: ROOMS "thrarandil024.c",
			"north"     : ROOMS "thrarandil028.c",
			"west"      : ROOMS "thrarandil026.c",
        ]));
