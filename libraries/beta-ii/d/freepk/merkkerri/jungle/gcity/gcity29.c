...
set("short", "%^YELLOW%^The inner sanctum of the Hall of Fighters%^RESET%^");
  set("long",
"%^YELLOW%^Welcome to the inner sanctum of the Hall of Fighters.\n"
"%^YELLOW%^Fighters gather here to advance in the art of combat and in life.  "
"%^YELLOW%^In this hall, a fighter may <advance>, <cost>, <list (number)>, "
"%^YELLOW%^<improve stat>, <train skill amount>, and <roll stats>.  To the southeast "
"you can enter the shimmering %^RESET%^BLUE%^blue%^RESET%^YELLOW%^ "
"%^YELLOW%^light back the entrance of the hall. You can choose a subclass here.%^RESET%^");
   set_exits(([
"southeast" : GCITY"gcity17.c",
...
ob->set_location(GCITY"gcity29.c");
...
int cmd_start(string str)
{
 ...
 this_player()->set_primary_start(ROOMS"fghrhall");
