...
set_long("%^YELLOW%^You have entered the Quixxiol rogue hall.  The rogues of %^YELLOW%^Quixxiol operate quite openly due to a strong political %^YELLOW%^foothold.  The Grand Master Rogue waits here to initiate new %^YELLOW%^members into rogue society.  You may <preview> what life is %^YELLOW%^like as the shadowy rogue.  A strange %^RESET%^BLUE%^blue%^RESET%^YELLOW%^ light guards the %^YELLOW%^entrance to the main chamber below.%^RESET%^");
    set_items(
