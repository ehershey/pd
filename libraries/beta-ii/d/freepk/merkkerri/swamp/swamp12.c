...
set_day_long("The trees have given way to a small lagoon.  The thick green plantlife is showered with sun from above.  You stand within the northeast waters.");
...
"southwest": SWAMP "swamp13.c",
"south": SWAMP "swamp14.c",
"west": SWAMP "swamp11.c",
])); 
}
void reset() {
::reset(); 
