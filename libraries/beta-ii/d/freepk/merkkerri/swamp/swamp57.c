...
set_long("From here the entire region can be seen as you stand upon a large wooden walkway that surrounds the upper tree.  Pixies can be seen flying to and fro while occassionally landing upon the walkway for a closer look at their visitors.");
...
"southeast": SWAMP "swamp61.c",
"northeast": SWAMP "swamp58.c",
"east": SWAMP "swamp59.c",
