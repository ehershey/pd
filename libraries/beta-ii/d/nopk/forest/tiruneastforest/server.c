...
void create() {
  ...
  set_listen("Animal calls and rustling noises drift in from deeper in the forest.");
  set_reset_list( ({
      MOB"badger", MOB"bear", MOB"bobcat", MOB"caribou", MOB"cougar", MOB"deer", MOB"elk", MOB"jaguar",
      MOB"lynx", MOB"moose", MOB"ocelot", MOB"porcupine", MOB"puma", MOB"ram", MOB"squirrel", MOB"wildcat",
      MOB"wolf",
  }) );
