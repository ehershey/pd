...
/*
    set_door("grate", "/wizards/zaknaifen/sewer/rooms/room3.c",
              "east", "obsidian key");
    set_open("grate", 0);
    set_locked("grate", 0);
*/
    ...
    set("long",
	"These sewers under Tirun are filled with slime. "
	"A grate is set in the east wall, near the ceiling. ");
    set_items(
	(["sewers" : "The disgusting tunnels of human waste under Tirun.",
	  "slime" : "Nasty, nasty.",
      ...
      set_exits(
	      (["west" : ROOMS"sewer_ent" ]) );

//		"east" : "/wizards/zaknaifen/sewer/rooms/room3"]) );
