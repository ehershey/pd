...
set_long("A well tended grove of trees.  The area seems to radiate magic.  Some of the trees have fruit on them.  To the north, one tree towers above all the others.  A path leads off the the east.");
    ...
    set_exits( (["north" : ROOMS+"clergy/druid/druid_tree"
             ,"east" : ROOMS+"clergy/druid/waterfall"
,"south" : "/d/nopk/standard/forest3.c"
              ]) );
