...
void create() {
    ...
    set_listen("upstairs", "You hear the chanting of the monks of Tirun.");
    ...
    set_long(
     ...
     "In this huge open monastary run by Tirun monks the dead come to pray for resurrection. "
        "A small stairway to the east leads to the monastary attic and "
        "basement. The Tirun Chapel where monks marry people is north. "
        "Ganthus road is outside the monastary to the south. ");
    set_exits( 
              (["south" : ROOMS "eganthus2",
"tower" : "/wizards/vian/tower.c",
"northwest" : "/d/guilds/knightsofvalor/entrance",
                "east" : ROOMS "stairs",
                "north" : ROOMS "chapel"]) );
