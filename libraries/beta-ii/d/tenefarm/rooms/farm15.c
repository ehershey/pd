...
void create() {
 ...
 set_night_long("The shadowy path goes southeast for some distance, but it also goes northwest. To the east a river flows gently south. The river continues to flow south until it suddenly collides with the path ahead, flooding it. To the northeast the dark spinning blades of the top of a large mill can be seen. The small black bump of the farmer's house can barely be seen to the northeast.");
  ...
  set_exits(([
    "northwest" : ROOMS"farm14",
    "southeast" : ROOMS"farm16"
   ]));
}
