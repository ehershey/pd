...
void execute_pearl_game(int max, object tp)
{
  ...
  case 9995 .. 9999 :
   ...
   case 9963 .. 9983 :
                 ...
                 break;
   case 9982 .. 9862 :
               message("info","You found a blue pearl!!",tp);
              message("info",tp->query_cap_name()+" found a blue pearl!!",environment(tp),tp);
              new(PEARLS"blue_pearl.c")->move(tp);
              break;
    case 9361 .. 9861 :
               message("info","You found a black pearl!!",tp);
               message("info",tp->query_cap_name()+" found a black pearl!!",environment(tp),tp);
