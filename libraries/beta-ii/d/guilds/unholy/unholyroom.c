...
void create() {
    ...
    set_day_long(
      ...
      "around a large form trapped inside.  Small amber fragments "
      "litter the floor.  This seems to be a place of worship."
    );
	...
	"creates",
	"light" : "The actual source of the light seems to be "
...
int cmd_start(string str)
{
    ...
    this_player()->set_primary_start("/d/guilds/unholy/unholyroom");
