...
void create() {
    ...
    set_name("Illuminati Merkkirri Subhall");
    set_short("Illuminati Merkkirri Subhall");
    set_long("%^ORANGE%^This is the Illuminati subhall of Merkkirri, an outpost of the Tower of Light. Members often come here to escape the harsh heat and humidity of the jungle. Large chairs all make a perfect spot to %^BOLD%^WHITE%^<relax>%^RESET%^ORANGE%^.%^RESET%^"); 
    set_exits(([
	"east" : "/d/freepk/merkkerri/jungle/merkkirri/mjungle3"
      ]));
    set_items(([
