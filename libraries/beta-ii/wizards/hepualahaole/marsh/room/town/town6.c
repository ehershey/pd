...
room::create();
   set_properties( ([ "light" : 2]) );
    ...
    set_day_long(
      "The town is hidden underneath a wild growth of "
      "vines.  Bits and pieces of buildings peek through "
      "the over-growth.  Workers scramble with no preveil "
      "of ridding the town of the infestation of vines."
          );
    set_night_long(
