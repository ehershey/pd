...
static void create()
{
 ...
 set_long("This is the newbie guide to Primal Darkness. Within is information "
          "on how to play, where to go, and what to do on Primal Darkness.");
...
if (str=="equipment")
  {
   message("info", 
"%^CYAN%^%^BOLD%^[ Equiping yourself to play ]%^RESET%^\n"
...
"will protect you from all damaege but it will all help protect you fro some damage.  Most "
...
"     O   O %^GREEN%^E%^RESET%^ O %^MAGENTA%^S%^RESET%^-O-O-O-O O %^GREEN%^H%^RESET%^ %^CYAN%^C%^RESET%^ O      | O : Room        |\n"
"     |   | | |   | | |   | | | |      | G : Gate        |\n"
" G-O-O-O-O-O-O-O-O-%^BOLD%^%^RED%^X%^RESET%^-O-O-O-O-O-O-O-G  +-----------------+\n"
"     |   | | |   | | | | |   | |      \n"
