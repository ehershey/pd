...
void create() {
   ...
   set_properties( ([ "light" : 2, "indoors" : 1]) );
    ...
    set_long(
      ...
      "A Carnival Atmosphere Held Together By The Slight Techno Music"
      "Lingers In The Air. You Now Understand The Evils That Exist In"
      "Such A Dark Man's Mind. Morgoth Wuz Here."
    );
    set_items(([
  ...
  "type 'h', this will display a list of commands for the built in editor."
   ...
   ({"wall", "the wall"}):
    ...
    ob->set_max_posts(50);
    ob->set_location("/wizards/morgoth/room/workroom.c");
