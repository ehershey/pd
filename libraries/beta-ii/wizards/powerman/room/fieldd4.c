...
northwest. Corpses litter the ground. Within the thick smog of dust, you see
...
set_exits( ([ "north": "/wizards/powerman/room/fieldd3.c",
              "west" : "/wizards/powerman/room/fieldc4.c",
              "south": "/wizards/powerman/room/fieldd5.c",
              "east" : "/wizards/powerman/room/fielde4.c",]));
}
