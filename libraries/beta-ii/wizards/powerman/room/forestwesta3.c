...
where you are.  The ground is soft and comfortable padded by the many leaves that fall at this time. It is such a shame that this area has been turned into a battlefield.");
...
set_exits( ([ "south": "/wizards/powerman/room/forestwesta4.c",
              "north": "/wizards/powerman/room/forestwesta2.c",
              "east" : "/wizards/powerman/room/forestwestb3.c", ]));
}
