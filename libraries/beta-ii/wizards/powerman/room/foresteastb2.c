...
where you are.  The ground is soft and
comfortable padded by the many leaves that fall at this time. You see tents set
up west.");
...
warm yourself up at. You spot a campfire west.");
set_items(([
...
set_exits( ([ "south": "/wizards/powerman/room/foresteastb3.c",
              "north": "/wizards/powerman/room/foresteastb1.c",
              "west" : "/wizards/powerman/room/foresteasta2.c", ]));
}
