...
dirty. You can see Macbeth's castle clearly being at the top of the gentle
hill. Corpses litter the ground. Within the thick smog of dust, you see
...
set_exits( ([ "north": "/wizards/powerman/room/fieldc2.c",
              "west" : "/wizards/powerman/room/fieldb3.c",
              "south": "/wizards/powerman/room/fieldc4.c",
              "east" : "/wizards/powerman/room/fieldd3.c",]));
}
