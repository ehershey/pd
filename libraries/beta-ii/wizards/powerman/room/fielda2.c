...
set_exits( ([ "north": "/wizards/powerman/room/fielda1.c",
              "west" : "/wizards/powerman/room/forestwestb4.c",
              "south": "/wizards/powerman/room/fielda3.c",
              "east" : "/wizards/powerman/room/fieldb2.c",]));
}
