...
set_day_long("The trees here are protect you from exposure to the battlefield.
The ground is soft and comfortable padded by the many leaves that fall at this
time. Northwards you see tents.");
...
set_exits( ([ "east": "/wizards/powerman/room/foresteastb7.c",
              "north": "/wizards/powerman/room/foresteasta6.c",
              "west" : "/wizards/powerman/room/fielde5.c", ]));
}
