...
set_exits( ([ "north": "/wizards/powerman/room/fielde1.c",
              "west" : "/wizards/powerman/room/fieldd2.c",
              "south": "/wizards/powerman/room/fielde3.c",
              "east" : "/wizards/powerman/room/foresteasta4.c",]));
}
