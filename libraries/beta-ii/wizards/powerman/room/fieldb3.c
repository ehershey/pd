...
set_exits( ([ "north": "/wizards/powerman/room/fieldb2.c",
              "west" : "/wizards/powerman/room/fielda3.c",
              "south": "/wizards/powerman/room/fieldb4.c",
              "east" : "/wizards/powerman/room/fieldc3.c",]));
}
