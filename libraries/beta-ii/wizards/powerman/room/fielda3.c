...
east. Corpses litter the ground. Within the thick smog of dust, you see
...
set_exits( ([ "north": "/wizards/powerman/room/fielda2.c",
              "west" : "/wizards/powerman/room/forestwestb5.c",
              "south": "/wizards/powerman/room/fielda4.c",
              "east" : "/wizards/powerman/room/fieldb3.c",]));
}
