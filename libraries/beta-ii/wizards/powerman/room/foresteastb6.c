...
that fall at this time. Westwards you see tents.");
...
set_exits( ([ "south": "/wizards/powerman/room/foresteastb7.c",
              "north": "/wizards/powerman/room/foresteastb5.c",
              "west" : "/wizards/powerman/room/foresteasta6.c", ]));
}
