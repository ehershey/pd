...
set_exits( ([ "north": "/wizards/powerman/room/fieldd4.c",
              "west" : "/wizards/powerman/room/fieldc5.c",
              "southwest": "/wizards/powerman/room/drawbridge.c",
              "east" : "/wizards/powerman/room/fielde5.c",]));
}
