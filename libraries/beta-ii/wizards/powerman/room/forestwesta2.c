...
set_day_long("You reach the edge of the woods. You can see the shoreline from where you are.  The ground is soft and
comfortable padded by the many leaves that fall at this time. You see tents set up east.");
...
warm yourself up at. You spot a campfire east.");
set_items(([
...
set_exits( ([ "south": "/wizards/powerman/room/forestwesta3.c",
              "north": "/wizards/powerman/room/forestwesta1.c",
              "east" : "/wizards/powerman/room/forestwestb2.c", ]));
}
