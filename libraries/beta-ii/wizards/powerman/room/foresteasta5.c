...
set_day_long("The ground is soft and comfortable padded by the many leaves that
fall at this time. It is such a shame that this area has been turned into a
battlefield. You see tents south.");
...
warm yourself up at. You see a fire southwards.");
set_items(([
...
set_exits( ([ "south": "/wizards/powerman/room/foresteasta6.c",
              "north": "/wizards/powerman/room/foresteasta4.c",
              "east" : "/wizards/powerman/room/foresteastb5.c",
              "west" : "/wizards/powerman/room/fielde3.c", ]));
}
