...
warm yourself up at. You see a faint fire glowing westwards. You see soldiers continue to battle through out the night.");
set_items(([
...
set_exits( ([ "west" : "/wizards/powerman/room/forestmida2.c",
              "south"     : "/wizards/powerman/room/fieldb1.c",
              "east" : "/wizards/powerman/room/forestmidc2.c",
              "north" : "/wizards/powerman/room/forestmidb1.c" ]));
}
