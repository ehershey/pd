...
smothered with dirt and thick black smoke rises to above the forest. You are
protected from the battlefields by the trees around.");
...
set_exits( ([ "south": "/wizards/powerman/room/foresteasta7.c",
              "north": "/wizards/powerman/room/foresteasta5.c",
              "east" : "/wizards/powerman/room/foresteastb6.c",
              "tent" : "/wizards/powerman/room/tent4.c",
              "west" : "/wizards/powerman/room/fielde4.c" ]));
}
