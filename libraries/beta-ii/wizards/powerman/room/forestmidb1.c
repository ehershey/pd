...
set_exits( ([ "west" : "/wizards/powerman/room/forestmida1.c",
              "south"     : "/wizards/powerman/room/forestmidb2.c",
              "east" : "/wizards/powerman/room/forestmidc1.c",
              "northeast": "/wizards/powerman/room/pathd.c" ]));
}
