...
set_exits( ([ "north": "/wizards/powerman/room/fieldb4.c",
              "west" : "/wizards/powerman/room/fielda5.c",
              "southeast": "/wizards/powerman/room/drawbridge.c",
              "east" : "/wizards/powerman/room/fieldc5.c",]));
}
