...
set_exits( ([ "north": "/wizards/powerman/room/forestmide2.c",
              "west" : "/wizards/powerman/room/fieldd1.c",
              "south": "/wizards/powerman/room/fielde2.c",
              "east" : "/wizards/powerman/room/foresteasta3.c",]));
}
