...
set_exits( ([ "north": "/wizards/powerman/room/forestmida2.c",
              "west" : "/wizards/powerman/room/forestwestb3.c",
              "south": "/wizards/powerman/room/fielda2.c",
              "east" : "/wizards/powerman/room/fieldb1.c",]));
}
