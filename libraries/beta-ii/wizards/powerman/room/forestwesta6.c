...
that fall at this time. Eastwards you see tents.");
...
set_exits( ([ "south": "/wizards/powerman/room/forestwesta7.c",
              "north": "/wizards/powerman/room/forestwesta5.c",
              "east" : "/wizards/powerman/room/forestwestb6.c", ]));
}
