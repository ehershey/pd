...
comfortable padded by the many leaves that fall at this time. You see soldiers fighting southwards.");
...
warm yourself up at. You see faint fires glowing westwards and eastwards. You see soldiers continue to battle through out the night.");
set_items(([
...
set_exits( ([ "west" : "/wizards/powerman/room/forestmidb2.c",
              "south"     : "/wizards/powerman/room/fieldc1.c",
              "east" : "/wizards/powerman/room/forestmidd2.c",
              "north" : "/wizards/powerman/room/forestmidc1.c" ]));
}
