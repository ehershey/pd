...
southwest. Corpses litter the ground. Within the thick smog of dust, you see
...
set_exits( ([ "north": "/wizards/powerman/room/fieldc1.c",
              "west" : "/wizards/powerman/room/fieldb2.c",
              "south": "/wizards/powerman/room/fieldc3.c",
              "east" : "/wizards/powerman/room/fieldd2.c",]));
}
...
if(!present("soldier")) {
new("/wizards/powerman/arm/malcapt")->move(this_object());
new("/wizards/powerman/arm/malsold")->move(this_object());
}
}
