...
set_exits( ([ "north": "/wizards/powerman/room/forestmidb2.c",
              "west" : "/wizards/powerman/room/fielda1.c",
              "south": "/wizards/powerman/room/fieldb2.c",
              "east" : "/wizards/powerman/room/fieldc1.c",]));
}
