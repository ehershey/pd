...
set_exits( ([ "north": "/wizards/powerman/room/fieldd1.c",
              "west" : "/wizards/powerman/room/fieldc2.c",
              "south": "/wizards/powerman/room/fieldd3.c",
              "east" : "/wizards/powerman/room/fielde2.c",]));
}
