...
set_exits( ([ "north": "/wizards/powerman/room/fieldb3.c",
              "west" : "/wizards/powerman/room/fielda4.c",
              "south": "/wizards/powerman/room/fieldb5.c",
              "east" : "/wizards/powerman/room/fieldc4.c",]));
}
