...
dirty. You are closer Macbeth's castle in the south. You are approaching
...
set_exits( ([ "north": "/wizards/powerman/room/fielde2.c",
              "west" : "/wizards/powerman/room/fieldd3.c",
              "south": "/wizards/powerman/room/fielde4.c",
              "east" : "/wizards/powerman/room/foresteasta5.c",]));
}
