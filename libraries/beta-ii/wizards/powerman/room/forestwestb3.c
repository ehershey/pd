...
set_day_long("Not much sunlight makes it through the forest canopy.  The ground is soft and comfortable padded by the many leaves that fall at this time. It is such a shame that this area has been turned into a battlefield. You see tents set up north.");
...
set_exits( ([ "south": "/wizards/powerman/room/forestwestb4.c",
              "north": "/wizards/powerman/room/forestwestb2.c",
              "west" : "/wizards/powerman/room/forestwesta3.c",
              "east" : "/wizards/powerman/room/fielda1.c", ]));
}
