...
set_exits( ([ "south": "/wizards/powerman/room/foresteasta5.c",
              "north": "/wizards/powerman/room/foresteasta3.c",
              "east" : "/wizards/powerman/room/foresteastb4.c",
              "west" : "/wizards/powerman/room/fielde2.c", ]));
}
