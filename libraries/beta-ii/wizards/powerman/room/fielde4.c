...
far northwest. Corpses litter the ground. Within the thick smog of dust, you
see reflections of sunlight off the weapons and armour of the soldiers in the
battle.");
...
set_exits( ([ "north": "/wizards/powerman/room/fielde3.c",
              "west" : "/wizards/powerman/room/fieldd4.c",
              "south": "/wizards/powerman/room/fielde5.c",
              "east" : "/wizards/powerman/room/foresteasta6.c",]));
}
