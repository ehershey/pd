...
void create() {
   ::create();
     ...
     set_day_long("Rhondale is heavily fortified against the dangerous inhabitants of the forest. The outer path circles the entire village just inside the walls. The cobblestones underfoot are smooth though not at all slippery. Here the northeast lookout tower stretches up from the wall.");
     ...
     set_exits(([
		"northwest"	: KEEPROOM"zvillage/outer0100.c",
		"southeast"	: KEEPROOM"zvillage/outer0200.c",
		"up"		: KEEPROOM"zvillage/netower.c"
                ]));
}
