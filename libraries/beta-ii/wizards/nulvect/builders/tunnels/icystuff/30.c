...
set_long("The icy tunnels are completely covered in a bright blue sheet of ice. A blinding light reflects off of every icy surface. The ground is covered in %^BOLD%^frozen%^RESET%^ stones of different sizes, scattered randomly throughout the %^BOLD%^snow%^RESET%^. Slipperiness makes traveling the tunnels dangerous. The air is composed of a fresh mixture of %^BOLD%^cold%^RESET%^ and clean.");
set_items(([
...
set_exits(([ "northwest" : ROOMS "/icystuff/28.c",
"east" : ROOMS "/icystuff/31.c"]));
}
