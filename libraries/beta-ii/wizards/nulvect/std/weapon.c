...
private static mapping DEFAULT_DAMAGE_TYPES = ([
  "axe" : DAMAGE_SLASH | DAMAGE_IMPACT,
  "blade" : ({ DAMAGE_SLASH, DAMAGE_SLASH, DAMAGE_PIERCE }),
  "blunt" : DAMAGE_IMPACT,
  "knife" : ({ DAMAGE_SLASH, DAMAGE_PIERCE, DAMAGE_PIERCE }),
  "flail" : DAMAGE_SLASH | DAMAGE_IMPACT,
  "projectile" : DAMAGE_PIERCE,
  "ranged" : DAMAGE_IMPACT,
]);

// flags that apply to idle rounds
private static mapping DEFAULT_DAMAGE_FLAGS = ([
  "knife" : DAMAGE_NO_SEVER,
  "flail" : DAMAGE_NO_SEVER | DAMAGE_NONLETHAL,
