...
set("short", "%^YELLOW%^The inner sanctum of the Magi%^RESET%^");
    set("long",
"%^YELLOW%^Welcome into the heart of the magi. "
"%^YELLOW%^ Mages come here to advance their knowledge of the magical arts.  "
"%^YELLOW%^The available commands are <cost>, <advance>, <list (number)>, "
"%^YELLOW%^<improve stat>, <train skill amount>, and <roll stats>.  The "
"exit guarded by the shimmering %^RESET%^BLUE%^blue%^RESET%^YELLOW%^ light is to the west.  "
"%^YELLOW%^<help skills> will list all skills with their full, proper names."
"%^YELLOW%^  You can choose a subclass here.%^RESET%^");
    set_exits( 
(["west" : GCITY "gcity20.c",
...
ob->set_location(GCITY "gcity30.c");
