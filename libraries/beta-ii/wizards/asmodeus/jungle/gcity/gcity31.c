...
set("short", "%^YELLOW%^The central chamber of the dark church%^RESET%^");
    set("long",
"%^YELLOW%^You stand within the central chamber of the Kataans dark church.  "
"%^YELLOW%^Kataans come here to advance in the art of combat and magic. "
"%^YELLOW%^The available commands are <cost>, <advance>, <list (number)>, "
"%^YELLOW%^<improve stat>, <train skill amount>, and <roll>.  "
"%^YELLOW%^You can reach the entrace to the church by passing through a shimmering %^RESET%^BLUE%^blue%^RESET%^YELLOW%^ light guarding the passage north.  "
"%^YELLOW%^<help skills> will list the full names of all skills.%^RESET%^");
    set_exits(([
"north" : GCITY "gcity18.c",
]) );
    ob = new("std/bboard");
    ob->set_name("board");
...
ob->set_location(GCITY "gcity31.c");
...
int roll() { call_other(ROOMS "setter", "do_rolls"); return 1; }
