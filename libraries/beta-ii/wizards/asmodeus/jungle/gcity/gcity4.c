...
set_long("%^YELLOW%^
You are in the local hospital run by the town's clerics.  Here they specialize in the regeneration of lost limbs.  A list of all services they perform is posted on the wall.%^RESET%^");
    set_items(
