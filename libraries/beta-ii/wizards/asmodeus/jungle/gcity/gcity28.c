...
set("short", "%^YELLOW%^The inner sanctum of the clerics%^RESET%^");
    set("long",
"%^YELLOW%^Welcome to the inner sanctum of the clerics. "
"%^YELLOW%^Clerics come here to reach a oneness with nature and reality.  "
"%^YELLOW%^The available commands are <cost>, <advance>, <list (number)>, "
"%^YELLOW%^<improve stat>, <train skill amount>, and <roll stats>.  "
"%^YELLOW%^Through the passage guarded by a shimmering%^RESET%^BLUE%^ blue%^RESET%^ "
"%^YELLOW%^light is the open area of the church.");
    set_exits( 
(["down" : GCITY"gcity24.c",
]) );
...
ob->set_location(GCITY"gcity28.c");
