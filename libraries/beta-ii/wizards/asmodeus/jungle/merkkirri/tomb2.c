...
set_long("You are in a long tunnel that runs north and south.  Darkness surrounds you and the cool air gives you an eerie chill.");
set_items(([
...
set_exits(([
"south": MJUNGLE "tomb3.c",
"north": MJUNGLE "tomb1.c",
]));
