...
::create();
    ...
    set_long("Little difference can be seen at any point in the hall.  This hall is very long and plain.  It is relatively featureless, if not for the subhalls leading east and west.  There appear "
