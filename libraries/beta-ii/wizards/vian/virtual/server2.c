...
void create() {
  ...
  set_day_sentances( ({
      ...
      "The thick growth of the forest makes the surrounding area dark and
ominous.",
      "The foliage of the trees grows together making a thick canopy that
blocks out the sun.",
      "Thick vines of some plant grow up the trunks of nearby trees.",
      "Trees of all shapes and sizes grow thick all around blocking any attempt
to leave the path.",
      "The path is the only opening in the thick underbrush that allows
passage.",
      "Tracks of a large feline run along the path for a ways then veer off
into the forest.",
      "The humidity of the forest is thick enough to cause the nearby trees to
sweat.",
      "A tree has fallen over the path long ago and is now rotting slowly.",
      "Vines, thorn bushes, and other plants grow thickly together between the
trees.",
      "Broken branches and trampled grass in the underbrush mark the passage of
some animal.",
      ...
      "The branches on a nearby tree look like the hands of some skeleton in
the poor light.",
      "Nearby, the leaves on a tree rustle as some animal makes it's way
through the tree tops." 
  ...
  set_night_sentances( ({
      ...
      "Dark shapes in the forest could be trees or might prove to be something
more ominous.",
      "The dark of night lends an evil menace to the forest.",
      "A howl off in the distance sends nearby animals scurrying through the
underbrush.",
      "Dark shapes move in the trees nearby.",
      "Shadowy shapes hang above the path, reaching down like hands prepared to
grasp anything passing nearby.",
      "Shadowy movements along the path might be trees swaying in the breeze or
they might be something more sinister.",
...
despair.",
      "Rustling sounds out in the forest lend themselves to the rustling sounds
underfoot.",
  ...
  set_item_list( ([
      ...
      "vines" : "The vines grow around trees and underbrush choking out the sky
and passage through the forest.",
      "path" : "An animal track through the underbrush.",
      ({"shadow", "shadows"}) : "Dark forms out in the forest.",
      "mound" : "A pile of dirt.",
      ({"limbs", "branches"}) : "Limbs covered in leaves growing from the
trees.",
      ...
      "canopy" : "At tree top level where thick foliage meet to form a roof of
leaves.",
      "remains" : "A rotting corpse of a rodent.",
      "underbrush" : "Small bushes, large weeds, and other kinds of plants
grown together in impassable clumps.",
      "shapes" : "Shadowy shapes in the darkened areas of the forest.",
      ({"thornbushes", "thorn bushes"}) : "A tangled mess of thorny bushes.",

  ]) );
  set_smell("The stench of decaying vegitation permeates the area.");
  set_listen("Animal calls and rustling noises drift in from deeper in the
forest.");
  ...
  set_short("A forest path east of Tirun.");
  set_mob_cap(2);
}
