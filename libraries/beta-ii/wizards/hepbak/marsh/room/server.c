...
void create() {
  ...
  set_day_sentances( ({
   ...
   "Something swimming in the water leaves a wake of ripples behind it off in the distance.",
  ...
  set_item_list( ([
        ...
        "ripples"   : "The trail left by something passing in the water.",
        "image" : "It was a quick movement but it was long enough to notice an old woman.",
        "woman" : "She might have looked haggard but it was only a quick glimpse.",
        "moss"  : "It grows on everything.",
        "branches" : "Tree branches.",
        "eyes"  : "The eyes poke up out of the murky water.",
        "mudbug"   : "They are everywhere moving around gathering food and other materials.",
        ...
        "twig" : "S small twig floating in the water.",
  ...
  set_reset_list( ({
      MOB"malligator", MOB"turtle", MOB"mbat", MOB"fwaterbug", MOB"fmosquito", MOB"mcockroach", MOB"mdragonfly",
      MOB"lizardman", MOB"fbat", MOB"mmosquito", MOB"fsnake", MOB"msnake", MOB"falligator",
      MOB"mwaterbug", MOB"mcockroach", MOB"mudbug"
  }) );
