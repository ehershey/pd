// Seeker's amulet faked by Inferno to catch cheaters.
...
{ 
 ...
 new("/d/standard/obj/mon/reaper")->move(environment(this_player()));
 present("reaper", environment(this_player()))->set_kill(this_player());
 new("/d/standard/obj/mon/angel")->move(environment(this_player()));
