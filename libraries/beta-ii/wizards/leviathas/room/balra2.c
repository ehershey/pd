...
::create();
    ...
    set_day_long("                             %^RED%^Blood is everywhere!                                                                                      "
                                                "%^BOLD%^This room looks like the inside of a heart!  The walls are beating and blood spurts out of tubes that hang from the ceiling.  Single drops of the darkest blood you've ever seen drip in through the hole.  These must be from the blood that that man on the ceiling dripped.  There is nothing more in here than pure blood, bubbling and splashing around.  A couple of %^RESET%^%^BOLD%^steel drains %^RED%^on the walls circulate the blood and purify it to achieve it's greatest potential. ");
    set_night_long("                           %^RED%^Blood is everywhere!                                                                                       "
                                                "%^BOLD%^This room looks like the inside of a heart!  The walls are beating and blood spurts out of tubes that hang from the ceiling.  Single drops of the darkest blood you've ever seen drip in through the hole.  These must be from the blood that that man on the ceiling dripped.  There is nothing more in here than pure blood, bubbling and splashing around.  A couple of %^RESET%^%^BOLD%^steel drains %^RED%^on the walls circulate the blood and purify it to achieve it's greatest potential. ");
