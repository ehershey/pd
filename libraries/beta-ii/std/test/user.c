...
inherit "/std/test/living";
inherit "/std/test/user/tsh";
inherit "/std/test/user/autoload";
inherit "/std/test/user/save";
inherit "/std/test/user/communication";
inherit "/std/test/user/edit";
inherit "/std/test/user/trace";
inherit "/std/test/user/bitflags";
inherit "/std/test/user/refs";
inherit "/std/test/user/pueblo";
inherit "/std/test/user/remort";
inherit "/std/test/user/more";
...
void restart_heart() {
    ...
    if(net_died_here && load_object(net_died_here)) {
...
string query_short() {
...

    {
        ...
        if (objectp(tmp = query_riding())) st += " (riding "+(userp(tmp)?tmp->query_cap_name():a_or_an(tmp->query_name())+" "+tmp->query_name())+")";
