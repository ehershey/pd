...
my $topdir = "/home/merentha/BUILD/MudOS_v21/lib";
my $logfile = "/home/merentha/BUILD/MudOS_v21/lib/log/adm/FTP";

my $server = "Merentha-Builders";              # must be changed, please
my $usertype = "$server wizard";
my $timeout = 1800;

my $passive_port = 9991;

## Trying to figure out your ip-number. Might need configure by hand.
my $hostname = `209.31.7.28`;
chomp($hostname);
...
sub players_path {
    my $u = shift;
    return "$topdir/secure/save/users/".substr($u,0,1)."/$u";
