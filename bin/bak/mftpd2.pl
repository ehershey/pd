...
my $topdir = "/home/merentha/MUD/MudOS_v21/lib";
my $logfile = "/home/merentha/MUD/MudOS_v21/lib/log/adm/FTP";

my $server = "Merentha";              # must be changed, please
my $usertype = "$server wizard";
my $timeout = 1800;

my $passive_port = 9901;
